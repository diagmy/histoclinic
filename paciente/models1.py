...
class Paciente(models.Model):
    ...
    sexo = models.CharField(max_length=9, choices=seleccion_sexo, blank=True)
    peso = models.FloatField(max_length=5, blank=True)
    direccion = models.CharField(max_length=50, blank=True)
    telefono = models.CharField(max_length=26, blank=True)
    celular = models.CharField(max_length=26, blank=True)
    ...
    tutor = models.CharField(max_length=30, blank=True)
    cedula_tutor = models.CharField(max_length=30, blank=True)
